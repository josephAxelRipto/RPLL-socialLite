...
function EditPost(props) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post(URL_API + `api/editCaption/${id}?caption=${caption}`).then((res) => {
            swal({
            ...
            {dataPost.map(data => (
                <div>
                    ...
                    <Row style={style.body}>
                        ...
                        <Col>
                            <img src={`data:image/jpeg;base64,${data.image}`} alt="post" style={style.imagePost}></img>
                        </Col>
                        <Col>
                            <Row>
                                <img src={localStorage.getItem('profileImage') === `data:image/jpeg;base64,null` ? Profile : localStorage.getItem('profileImage')} alt="profile" style={style.profile}>
                                </img>
