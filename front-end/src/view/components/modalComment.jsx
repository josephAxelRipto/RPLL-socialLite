...
import { Container, Modal, Row, Col, Button, Toast, Form } from 'react-bootstrap';
...
function ModalComment(props) {
    ...
    return (
        <Modal
            ...
            <Modal.Footer >
                {props.page === "profile"? <Button variant="light" onClick={props.showEdit}><img src={Edit} alt="edit"></img></Button>: ""}
                {props.page === "bookmark"? <Button variant="light" onClick={props.removeBookmark}><img src={Bookmark} alt="bookmark"></img></Button>: ""}
                <img src={props.profile !== "data:image/jpeg;base64,null" ? props.profile : Profile} alt="iconComment" style={style.icon_comment}></img>
                <Form onSubmit={props.handleSubmit}>
                    <Row style={style.rowComment}>
                        ...
                        <Col sm={8}>
                            <Form.Control type="text" placeholder="Enter Comment" name="comment" style={style.form} value={props.value} onChange={props.handleChange} autoComplete="off" />
                        </Col>
                        <Col sm={2}>
