...
class formEditProfile extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios.post(URL_API + `api/EditProfile/${this.state.id}`, data).then((res) => {
            swal({
            ...
            <div>
                <Row className="justify-content-md-center" class="mb-5">
                    ...
                    <Col>
                        ...
                        <Button variant="light" onClick={() => this.setState({show: true})}>Change Photo Profile </Button>
                        <ModalChangeProfile 
                    ...
                    <Col xs lg="6">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            >
                                ...
                                <Col sm={10}>
                                    <Form.Control type="text" name="username" defaultValue={this.state.username} placeholder="Masukkan Username" onChange={(event) => this.handleChange(event)} />
                            ...
                            >
                                ...
                                <Col sm={10}>
                                    <Form.Control type="text" name="fullname" placeholder="Masukkan Nama" defaultValue={this.state.fullname} onChange={(event) => this.handleChange(event)} />
                                </Col>
                            </Form.Group>
                            <Form.Group
                                as={Row}
